...
import br.com.faguirre.dao.jpa.ClienteJpaDAO;
import br.com.faguirre.dao.jpa.IClienteJpaDAO;
import br.com.faguirre.dao.jpa.IProdutoJpaDAO;
import br.com.faguirre.dao.jpa.IVendaJpaDAO;
import br.com.faguirre.dao.jpa.ProdutoJpaDAO;
import br.com.faguirre.dao.jpa.VendaJpaDAO;
...
public class VendaJpaDAOTest {
	...
	private ClienteJpa cadastrarCliente() throws TipoChaveNaoEncontradaException, DAOException {
		...
		cliente.setCidade("Cat");
		cliente.setEnd("End");
		cliente.setEstado("SP");
		cliente.setNumero(12);
		cliente.setTel(1212121212L);
